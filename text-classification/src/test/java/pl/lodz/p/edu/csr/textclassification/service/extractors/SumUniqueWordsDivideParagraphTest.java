...
public class SumUniqueWordsDivideParagraphTest {
    ...
    SumUniqueWordsDivideParagraph sumUniqueWordsDivideParagraph = new SumUniqueWordsDivideParagraph();
    ...
    public void extractScore(){
        double actual = sumUniqueWordsDivideParagraph.extract(text, uniqueWords,commonWords);
