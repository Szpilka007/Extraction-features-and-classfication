...
//
//public class SumUniqueWordsDivideAmountWordsTest {
//
//    double expectedValue = 0.091;
//
//    ArrayList<String> uniqueWords = new ArrayList<>(Arrays.asList("we","be","is"));
//    ArrayList<String> commonWords = new ArrayList<>(Arrays.asList("as","like"));
//    SumUniqueWordsDivideAmountWords sumUniqueWordsDivideAmountWords = new SumUniqueWordsDivideAmountWords();
//
...
//        double actual = sumUniqueWordsDivideAmountWords.extract(text, uniqueWords,commonWords);
