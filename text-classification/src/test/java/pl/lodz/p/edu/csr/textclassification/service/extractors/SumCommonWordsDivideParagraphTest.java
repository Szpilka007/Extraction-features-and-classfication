...
//
//public class SumCommonWordsDivideParagraphTest {
//
//    double expectedValue = 1.5;
//
//    ArrayList<String> uniqueWords = new ArrayList<>(Arrays.asList("sun","bee"));
//    ArrayList<String> commonWords = new ArrayList<>(Arrays.asList("world","the","we","be"));
//    SumCommonWordsDivideParagraph sumCommonWordsDivideParagraph = new SumCommonWordsDivideParagraph();
...
//        double actual = sumCommonWordsDivideParagraph.extract(text, uniqueWords,commonWords);
//        Assert.assertEquals(expectedValue,actual,1.0);
//    }
//}
