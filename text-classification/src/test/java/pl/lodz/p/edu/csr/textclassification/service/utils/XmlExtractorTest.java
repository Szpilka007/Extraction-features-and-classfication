...
class XmlExtractorTest {
    ...
    void extractTwoElements() {
        ...
        List<String> actual = xmlExtractor.extractElement(exampleText, ElementType.SIMPLE);
    ...
    void prepareReuters() {
        ...
        LocalDate expectedLocalDate = LocalDate.of(1987, 3, 5);
        ...
        ReutersEntity actual = xmlExtractor.prepareReuters(rawText);
